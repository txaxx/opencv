...
int main(){
	...
	//显示结果
	cv::putText(filter_box,"blur",cv::Point(20, 30),cv::FONT_HERSHEY_SIMPLEX,1.0,cv::Scalar(255));
	cv::putText(filter_gaussian,"GaussianBlur",cv::Point(20, 30),cv::FONT_HERSHEY_SIMPLEX,1.0,cv::Scalar(255));
	cv::putText(filter_median,"medianBlur",cv::Point(20, 30),cv::FONT_HERSHEY_SIMPLEX,1.0,cv::Scalar(255));
	cv::putText(filter_bila,"bilateralFilter",cv::Point(20, 30),cv::FONT_HERSHEY_SIMPLEX,1.0,cv::Scalar(255));
